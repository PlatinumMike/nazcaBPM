...
std::vector<std::complex<double> > Engine::get_initial_profile(const std::vector<double> &xgrid,
...
std::vector<std::complex<double> > Engine::do_step_euler(const std::vector<std::complex<double> > &field,
                                                         const std::vector<double> &xgrid,
...
std::vector<std::complex<double> > Engine::do_step_rk4(const std::vector<std::complex<double> > &field,
                                                       const std::vector<double> &xgrid,
                                                       const std::vector<double> &ygrid, double z,
                                                       const double dz) const {
